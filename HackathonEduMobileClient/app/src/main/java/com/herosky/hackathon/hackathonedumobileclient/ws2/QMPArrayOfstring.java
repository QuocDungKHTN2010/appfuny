...
public class QMPArrayOfstring extends Vector< String> implements KvmSerializable
{
    
    public QMPArrayOfstring(){}
    
    public QMPArrayOfstring(java.lang.Object inObj,QMPExtendedSoapSerializationEnvelope __envelope)
    {
        if (inObj == null)
            return;
