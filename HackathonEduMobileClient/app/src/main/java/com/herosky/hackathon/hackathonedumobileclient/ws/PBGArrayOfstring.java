...
public class PBGArrayOfstring extends Vector< String> implements KvmSerializable
{
    
    public PBGArrayOfstring(){}
    
    public PBGArrayOfstring(java.lang.Object inObj,PBGExtendedSoapSerializationEnvelope __envelope)
    {
        if (inObj == null)
            return;
