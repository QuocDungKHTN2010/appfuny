...
public class PBGExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    static HashMap< java.lang.String,java.lang.Class> classNames = new HashMap< java.lang.String, java.lang.Class>();
    static {
        classNames.put("http://schemas.datacontract.org/2004/07/WCFApp.DTO^^Teacher",PBGTeacher.class);
        classNames.put("http://schemas.datacontract.org/2004/07/WCFApp.DTO^^Teacher_Student_Mapping",PBGTeacher_Student_Mapping.class);
        classNames.put("http://schemas.datacontract.org/2004/07/WCFApp.DTO^^Parent",PBGParent.class);
        classNames.put("http://schemas.datacontract.org/2004/07/WCFApp.DTO^^Student",PBGStudent.class);
        classNames.put("http://schemas.datacontract.org/2004/07/WCFApp.DTO^^ArrayOfTeacher_Student_Mapping",PBGArrayOfTeacher_Student_Mapping.class);
        classNames.put("http://schemas.microsoft.com/2003/10/Serialization/Arrays^^ArrayOfstring",PBGArrayOfstring.class);
    }   

    protected static final int QNAME_NAMESPACE = 0;
    private static final String TYPE_LABEL = "type";

    public PBGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PBGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PBGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            ...
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=String.class)) {
                java.lang.String xmlName=PBGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public java.lang.Object get(java.lang.Object soap,java.lang.Class cl)
    {
        ...
        try
        {
            ...
            {
                Constructor ctor = cl.getConstructor(java.lang.Object.class,PBGExtendedSoapSerializationEnvelope.class);
